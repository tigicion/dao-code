export const zh: Record<string, string> = {
  ...
  "cmd.plugin": "查看已装插件",
  "cmd.account": "账户:切换/添加/删除(弹选择器;add <key> [provider] [name] 走文本)",
  ...
  // 账户选择器/添加
  "ui.account.providerPickerTitle": "这个账户是哪个 provider?↑↓ 选 · ⏎ 确认 · Esc 取消",
  "ui.account.pastePrompt": "粘贴 {0} 的 key(留空取消):",
  "ui.account.providerLabel.deepseek": "DeepSeek 官方",
