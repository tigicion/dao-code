export const zh: Record<string, string> = {
  ...
  "cmd.mode": "切换权限模式(default/auto/yolo;plan 用 /plan 进)",
  ...
  "ui.approval.sensitivePlain": "敏感操作(.ssh/.git/凭据等) · [y]是(仅本次) [a]始终允许(同类不再问) [n]否",
...
export const zhTips: string[] = [
  ...
  "Shift+Tab 循环权限模式:默认 → auto(AI 裁决) → yolo",
  "/bypass 免审批(慎用);deny 规则与危险命令(rm -rf / 等)仍会拦你",
