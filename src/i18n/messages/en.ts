export const en: Record<string, string> = {
  ...
  "onboard.provider.minimax": "MiniMax (direct)",
  ...
  "onboard.key.help.minimax": "Get a key: MiniMax platform → API keys (global: platform.minimax.io · CN: platform.minimaxi.com)",
  ...
  "cmd.account": "Accounts: switch/add/remove (picker; text: add <key> [provider] [name])",
  ...
  // Account picker / add
  "ui.account.providerPickerTitle": "Which provider is this account for? ↑↓ select · ⏎ confirm · Esc cancel",
  "ui.account.pastePrompt": "Paste the {0} key (blank to cancel): ",
  "ui.account.providerLabel.deepseek": "DeepSeek official",
  "ui.account.providerLabel.volcengine": "Volcengine coding plan",
  "ui.account.providerLabel.qianfan": "Qianfan token plan",
  "ui.account.providerLabel.minimax": "MiniMax direct",
