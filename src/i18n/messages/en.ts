export const en: Record<string, string> = {
  ...
  "cmd.mode": "Switch permission mode (default/auto/yolo; plan via /plan)",
...
export const enTips: string[] = [
  ...
  "Shift+Tab cycles permission modes: default → auto (AI-judged) → yolo",
  "/bypass skips approvals (careful); deny rules and dangerous commands (rm -rf /…) still block you",
