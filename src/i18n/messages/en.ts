export const en: Record<string, string> = {
  ...
  "mode.bypassPermissions": "※ Full grant (no approval)",
  ...
  "cmd.mode": "Switch permission mode (smart/full grant toggle)",
  ...
  "cmd.bypass": "Toggle full grant (skip approvals)",
