...
export const notifyUserTool = defineTool({
  ...
  description:
    ...
    "这是直达人类桌面;和子代理专用的 message_parent(发给派发你的父代理,排队等它空闲)是完全不同的通道,别搞混。" +
  ...
  descriptionEn:
    ...
    "This goes straight to the human's desktop; it's a completely different channel from message_parent (subagent-only, goes to the parent agent that dispatched " +
