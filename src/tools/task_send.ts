...
export const taskSendTool = defineTool({
  ...
  descriptionEn:
    "Sends an additional instruction (SendMessage) to a running background subagent task; it will receive it at the next tool turn boundary. Use for mid-course correction or supplementary information.",
  capability: "plan",
  approval: "auto",
  schema: z.object({
